const CACHE_NAME='ventas-victor-v2.3.1-recuperacion-inventario-selector';
const APP_SHELL=[
 './','./index.html','./manifest.webmanifest','./supabase-config.js?v=2.3.1','./app-v2.js?v=2.3.1','./app-v2.1.js?v=2.3.1','./app-v2.2.js?v=2.3.1','./app-v2.3.js?v=2.3.1',
